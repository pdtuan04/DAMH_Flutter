...
class UploadService {
  ...
  static const String _uploadVideoUrl = 'http://10.0.2.2:5084/api/Upload/upload-video';
        ...
        try {
           ...
           if (body is Map) {
             if (body['status'] == true && body.containsKey('filePath')) {
               ...
               print("Upload video failed logical: ${body['message']}");
               return null;
             }
           }
           // Fallback
           ...
           print("Error parsing video response: $e");
           return response.body; 
        }
      } else {
        print("Upload video failed: ${response.statusCode} - ${response.body}");
        return null;
      }
    } catch (e) {
