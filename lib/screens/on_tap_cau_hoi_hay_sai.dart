...
class CauHoiHaySaiScreen extends StatefulWidget {
  const CauHoiHaySaiScreen({
    super.key
  });

  @override
  State<CauHoiHaySaiScreen> createState() => _CauHoiHaySaiScreenState();
}

class _CauHoiHaySaiScreenState extends State<CauHoiHaySaiScreen> {
  ...
  void initState() {
    super.initState();
    _futureCauHois = ApiCauHoiService.getCauHoiHaySai(20);
  }
